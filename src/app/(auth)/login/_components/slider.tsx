...
//         {/* Caption */}
//         <div className="pointer-events-none absolute bottom-[10%] left-1/2 w-[78%] max-w-[560px] -translate-x-1/2 text-center text-white">
//           <p
//             aria-live="polite"
//             className="font-hnd text-[28px] leading-[1.2] tracking-[-0.06em] md:text-[30px]"
//           >
//             {active.title}
//           </p>
//         </div>
...
//       )}
//     >
//       <div className="relative z-10 w-[78%] max-w-[560px] aspect-[3/2]">
//         <Image
//           src={slide.img}
//           alt="chart"
//           fill
//           sizes="(min-width: 1280px) 560px, (min-width: 1024px) 480px, 80vw"
