...
export function Sidebar() {
  ...
  const nav: NavItem[] = [
    { href: "/user/dashboard", label: "Dashboard", icon: DashboardIcon },
    {
      ...
      sublinks: [
        {
          href: "/user/requests/status",
          label: "Request status",
          icon: RequestStatus,
        },
        {
          href: "/user/requests/channeled",
          label: "Channels Requests",
          icon: ChanneledRequestsIcon,
        },
      ],
    },
    { href: "/user/claims", label: "Claims", icon: ClaimIcon },
    { href: "/user/report", label: "Report", icon: ReportsIcon },
    { href: "/user/beneficiaries", label: "Beneficiaries", icon: PeopleIcon },
    { href: "/user/providers", label: "Providers", icon: HospitalIcon },
    { href: "/user/schemes", label: "Schemes", icon: MessageTextIcon },
    { href: "/user/call-agent", label: "Call Agent", icon: MessageTextIcon },
    { href: "/user/billings", label: "Billings", icon: BillingIcon },
